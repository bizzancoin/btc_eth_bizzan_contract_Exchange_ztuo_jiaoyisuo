    ...
    <div class="footer">
      <div class="footer_content">
        <div class="footer_left">
          ...
          <p>Copyright © 2019 - btxchain.com All rights reserved.&nbsp;&nbsp;</p>
          <div class="social-list">
            <ul>
              ...
              <Tooltip content="https://weibo.com/btxchain" theme="dark" placement="top">
                <li>
              ...
              <Tooltip content="https://www.reddit.com/u/btxchainglobal" theme="dark" placement="top">
                <li>
          ...
          <ul>
            ...
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">service@btxchain.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">support@btxchain.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">list@btxchain.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">ceo@btxchain.com</p>
                </div>
              </poptip>
            </li>
          </ul>
  ...
  watch: {
    activeNav: function() {
      switch (this.activeNav) {
        case "nav-exchange":
          window.document.title = (this.lang == "简体中文" ? "交易中心" : "Exchange") + " - BTXCHAIN 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-service":
          window.document.title = (this.lang == "简体中文" ? "公告" : "Announcement") + " - BTXCHAIN  全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-about":
          window.document.title = (this.lang == "简体中文" ? "关于" : "About") + " - BTXCHAIN  全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-lab":
          window.document.title = (this.lang == "简体中文" ? "创新实验室" : "Lab") + " - BTXCHAIN 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-invite":
          window.document.title = (this.lang == "简体中文" ? "推广合伙人" : "Promotion") + " - BTXCHAIN 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        default:
          window.document.title = "BTXCHAIN- 全球比特币交易平台 | 全球数字货币交易平台";
          break;
      }
    },
    $route(to, from) {
