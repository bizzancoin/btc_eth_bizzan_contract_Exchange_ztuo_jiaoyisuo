    ...
    <div class="wrapper">
      ...
      <div class="content_wrapper">
        ...
        <div class="content1">
          ...
          <p>{{$t('description.service')}}：service@btxchain.com</p>
          <p>{{$t('description.support')}}：support@btxchain.com</p>
          <p>{{$t('description.apply')}}：apply@btxchain.com</p>
          <p>{{$t('description.report')}}：ceo@btxchain.com</p>
          <p>{{$t('description.coop')}}：coop@btxchain.com</p>
        </div>
        <div class="content1" style="border:none;">
          <h5>{{$t('description.community')}}</h5>
          <p>{{$t('description.wechat')}}：{{$t('description.addwechat')}}</p>
          <p>{{$t('description.weibo')}}：https://weibo.com/btxchain</p>
          <p>{{$t('description.twitter')}}：https://twitter.com/btxchainGlobal</p>
          <p>{{$t('description.biyong')}}：https://0.plus/btxchainofficial</p>
          <p>{{$t('description.telegram')}}：https://t.me/btxchainofficial</p>
          <p>{{$t('description.medium')}}：https://medium.com/@btxchain</p>
          <p>{{$t('description.reddit')}}：https://www.reddit.com/u/btxchainglobal</p>
        </div>
      </div>
    </div>
  </div>
