...
public class ExchangeRobotNormal implements Runnable, IExchangeRobot{
	...
	protected String currenOrderURL = "http://api.bizzans.com/exchange/order/mockcurrentydhdnskd";
	protected String cancelOrderURL = "http://api.bizzans.com/exchange/order/mockcancelydhdnskd";
	protected String exchangeTYPE = "LIMIT_PRICE";
	protected String directionSELL = "SELL";
	protected String commitOrderURL = "http://api.bizzans.com/exchange/order/mockaddydhdnskd";
	protected String plateURL = "http://api.bizzans.com/market/exchange-plate-mini";
		...
		while(true) {
			...
			try {
				...
				if(plateResult != null && !plateResult.equals("")) {
					...
					// 买盘价格大于0
					if(bidHighestPrice.compareTo(BigDecimal.ZERO) > 0) {
