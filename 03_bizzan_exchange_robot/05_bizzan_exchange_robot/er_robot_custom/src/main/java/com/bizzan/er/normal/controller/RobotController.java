...
import com.bizzan.er.normal.robot.IExchangeRobot;
...
public class RobotController {
	...
	public MessageResult robotList(){
		...
		Map<String, IExchangeRobot> robotList = exchangeRobotFactory.getRobotList();
		for (Map.Entry<String, IExchangeRobot> entry : robotList.entrySet()) {
	...
	public MessageResult createRobot(@RequestBody RobotParams params) {
		...
		if(exchangeRobotFactory.containsExchangeRobot(params.getCoinName())) {
			...
			IExchangeRobot robot = new ExchangeRobotNormal();
	...
	public MessageResult startRobot(String coinName) {
		...
		if(exchangeRobotFactory.containsExchangeRobot(coinName)) {
			IExchangeRobot robot = exchangeRobotFactory.getExchangeRobot(coinName);
			robot.startRobot();
